...
public class TileUtils {
    ...
    public static Tile decode(int zoom, int col, int row, VectorTile.tile vtile) {
        ...
        for (VectorTile.tile.layer vlayer : vtile.getLayersList()) {
            ...
            if (vlayer.getVersion() != SUPPORTED_VERSION) {
                throw new UnsupportedOperationException("Layer version reported as " + vlayer.getVersion() + ", which is unsupported.");
            }
    ...
    protected static List<Integer> encodeGeometry(Shape shape) {
        ...
        throw new UnsupportedOperationException("Unsupported Shape class: " + shape.getClass());
    }
    ...
    protected static List<Integer> compact(List<Integer> instructions) {
